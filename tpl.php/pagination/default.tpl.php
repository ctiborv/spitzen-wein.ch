...
$_e_[7]->set('text', 'celkový počet stran: 1');
$_e_[6]->set('class', 'lista');
$_e_[6]->add($_e_[7]);
$_e_[5]->set('eid', 'obsah');
$_e_[5]->set('specification', '1');
$_e_[5]->add($_e_[6]);
$_e_[8] = $_b_->build('flow');
$_e_[9] = $_b_->build('div');
$_e_[10] = $_b_->build('text_content');
$_e_[10]->set('text', 'celkový počet stran: 0');
$_e_[9]->set('class', 'lista');
$_e_[9]->add($_e_[10]);
$_e_[8]->set('eid', 'obsah');
$_e_[8]->set('specification', '0');
$_e_[8]->add($_e_[9]);
$_e_[0]->add($_e_[1]);
$_e_[0]->add($_e_[5]);
$_e_[0]->add($_e_[8]);
