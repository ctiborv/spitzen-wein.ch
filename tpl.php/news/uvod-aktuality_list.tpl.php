...
$_e_[18]->set('eid', 'zadne_novinky');
$_e_[19] = $_b_->build('flow');
$_e_[19]->set('eid', 'prazdna_stranka');
$_e_[20] = $_b_->build('flow');
$_e_[20]->set('eid', 'novinky');
$_e_[21] = $_b_->build('h2');
$_e_[22] = $_b_->build('text_content');
$_e_[22]->set('text', 'Neuheiten');
$_e_[21]->add($_e_[22]);
$_e_[23] = $_b_->build('pagination');
$_e_[23]->set('eid', 'dolni_paginace');
$_e_[23]->set('vid', 'paginace');
$_e_[23]->set('case', 'bottom');
$_e_[23]->set('radius', '2');
$_e_[23]->set('template', 'pagination/teloL-aktuality');
$_e_[17]->set('class', 'teloL-news');
$_e_[17]->add($_e_[18]);
$_e_[17]->add($_e_[19]);
$_e_[17]->add($_e_[20]);
$_e_[17]->add($_e_[21]);
