...
$_e_[14] = $_b_->build('news');
$_e_[14]->set('mid', '5');
$_e_[14]->set('template', 'news/uvod-aktuality');
$_e_[14]->set('images', 'lightbox');
$_e_[14]->set('detailpage', 'aktuality detail');
$_e_[14]->set('ns', 'aktuality');
$_e_[14]->set('nsd', '');
$_e_[14]->set('active', '1');
$_e_[15] = $_b_->build('article');
$_e_[15]->set('template', 'search/vyhledavani');
