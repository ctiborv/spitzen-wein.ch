...
$_e_[18]->set('mid', '4');
$_e_[18]->set('template', 'article/teloP-kontakte');
$_e_[18]->set('images', 'lightbox');
$_e_[19] = $_b_->build('mailer');
$_e_[19]->set('template', 'mailer/kontakt');
$_e_[19]->set('contact', 'admin');
$_e_[19]->set('ns', 'kt');
$_e_[19]->set('subject', 'Nachricht aus website spitzen-wein.ch');
$_e_[20] = $_b_->build('br');
$_e_[20]->set('class', 'clear');
...
$_e_[21]->set('template', 'article/spodni');
$_e_[22] = $_b_->build('article');
$_e_[22]->set('template', 'article/copyright');
$_e_[1]->set('id', 'peak');
$_e_[1]->set('class', 'bv0');
$_e_[1]->add($_e_[2]);
