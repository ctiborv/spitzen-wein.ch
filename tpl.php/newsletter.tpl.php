...
$_e_[22]->set('mid', '6');
$_e_[22]->set('template', 'article/teloL-bannery');
...
$_e_[24] = $_b_->build('newslettersubscriber');
$_e_[24]->set('ns', 'test');
$_e_[24]->set('template', 'newslettersubscriber/ch');
$_e_[24]->set('successPage', 'newsletter');
$_e_[23]->set('class', 'teloP span9');
$_e_[23]->add($_e_[24]);
$_e_[25] = $_b_->build('br');
$_e_[25]->set('class', 'clear');
...
$_e_[26]->set('template', 'article/spodni');
$_e_[27] = $_b_->build('article');
$_e_[27]->set('template', 'article/copyright');
$_e_[1]->set('id', 'peak');
$_e_[1]->set('class', 'bv0');
$_e_[1]->add($_e_[2]);
