...
<p eid="nejsou_produkty" class="katalog-info">Keine Produkte gefunden...</p>
<p eid="prazdna_stranka" class="katalog-warning">Kein Produkt gefunden, die Seitenummer ist zu gross...</p>
<flow eid="jsou_produkty">
	<table eid="produkty" id="tab-katalog" cellspacing="0" cellpadding="0">
	</table>
</flow>
<pagination eid="dolni_paginace" vid="paginace" case="bottom" radius="2" template="pagination/katalog"  />
