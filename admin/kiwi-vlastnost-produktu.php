...
require_once 'include/kiwi_productproperty_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_productproperty_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('KATALOG', $rights);
$page_items[] = $kiwi_productproperty_form = new Kiwi_ProductProperty_Form();
...
<?=$kiwi_menubar->getHTML("\t");?>
	...
	<div id="stred">
		<div id="levy">
<?=$kiwi_productproperty_form->getHTML("\t\t\t");?>
		</div>
		<br class="clear" />
	</div>
	<!--Pata-->
