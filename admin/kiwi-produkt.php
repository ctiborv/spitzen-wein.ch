...
require_once 'include/kiwi_product_form.class.php';
...
$html_header->addJS(array(
	...
	'./js/jquery.dd.js',
	'./js/kiwi_product_form.js'
));
$html_header->addCss('./styles/style.css');
$html_header->addCss('./styles/dd.css');

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('KATALOG', $rights);
$page_items[] = $kiwi_product_form = new Kiwi_Product_Form($rights);
