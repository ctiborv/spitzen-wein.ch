...
require_once 'include/kiwi_modules_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_modules_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('WWW', $rights);
$page_items[] = $kiwi_modules_form = new Kiwi_Modules_Form($rights);
