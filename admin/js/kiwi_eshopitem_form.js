function Kiwi_EShopItem_Form_Class()
{
	this.enableBtns = function(s)
	{
		cmds = new Array('keifc_cmd5', 'keifc_cmd6', 'keifc_cmd7');
		size = cmds.length;
	...
	{
		var qc = 'ri';
		btn = document.getElementById('keifc_cmd1');
		if (btn.disabled)
	...
	{
		name = document.getElementById('keifc_name');
		if (name.value == '')
		{
		...
		auto = document.getElementById('keifc_auto');
		url = document.getElementById('keifc_url');
		if (url)
		{
	...
	{
		cb = document.getElementById('keifc_auto');
		url = document.getElementById('keifc_url');
		htitle = document.getElementById('keifc_htitle');
		dis = cb.checked;
...
var Kiwi_EShopItem_Form = new Kiwi_EShopItem_Form_Class();