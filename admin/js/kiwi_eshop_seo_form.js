function Kiwi_EShop_SEO_Form_Class()
{
	this.loaded = false;
	...
	this.loadCheck = function()
	{
		if (!this.loaded)
		{
			alert('Bitte warten Sie, während die Seite vollständigt ist.');
			return false;
		}
		return true;
	}
	...
	this.enableBtns = function(s)
	{
		...
		var i;
		for (i = 0; i < size; i++)
			cmdos[i] = document.getElementById('kesfc_cmd' + cmds[i]);
...
var Kiwi_EShop_SEO_Form = new Kiwi_EShop_SEO_Form_Class();

function myOnLoad()
{
	Kiwi_EShop_SEO_Form.onLoad();
}
