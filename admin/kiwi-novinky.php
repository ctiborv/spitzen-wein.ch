...
require_once 'include/kiwi_news_form.class.php';
...
$html_header->addJS(array('./js/utils.js', '/fckeditor/fckeditor.js', './js/kiwi_news_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('WWW', $rights);
$page_items[] = $kiwi_news_form = new Kiwi_News_Form($rights);
