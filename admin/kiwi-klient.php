...
require_once 'include/kiwi_client_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_client_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('KATALOG', $rights);
$page_items[] = $kiwi_client_form = new Kiwi_Client_Form();
