...
require_once 'include/kiwi_currency_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_currency_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('KATALOG', $rights);
$page_items[] = $kiwi_currency_form = new Kiwi_Currency_Form($rights);
