...
require_once 'include/kiwi_modnews_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_modnews_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('WWW', $rights);
$page_items[] = $kiwi_modnews_form = new Kiwi_ModNews_Form($rights);
