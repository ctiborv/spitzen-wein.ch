...
require_once 'include/kiwi_actions_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_actions_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('KATALOG', $rights);
$page_items[] = $kiwi_actions_form = new Kiwi_Actions_Form($rights);
