...
require_once 'include/kiwi_order_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_order_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('KATALOG', $rights);
$page_items[] = $kiwi_order_form = new Kiwi_Order_Form();
