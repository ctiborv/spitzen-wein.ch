...
require_once 'include/kiwi_eshop_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_eshop_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('KATALOG', $rights);
$page_items[] = $kiwi_eshop_form = new Kiwi_EShop_Form($rights);
