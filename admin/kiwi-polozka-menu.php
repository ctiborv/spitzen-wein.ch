...
require_once 'include/kiwi_menuitem_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_menuitem_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('WWW', $rights);
$page_items[] = $kiwi_menuitem_form = new Kiwi_MenuItem_Form($rights);
