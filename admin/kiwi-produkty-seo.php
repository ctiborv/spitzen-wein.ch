...
require_once 'include/kiwi_products_seo_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_products_seo_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('SEO', $rights);
$page_items[] = $kiwi_products_seo_form = new Kiwi_Products_SEO_Form($rights);
...
<?=$kiwi_menubar->getHTML("\t");?>
	...
	<div id="stred">
		<div id="levy">
<?=$kiwi_products_seo_form->getHTML("\t\t\t");?>
		</div>
		<br class="clear" />
	</div>
	<!--Pata-->
