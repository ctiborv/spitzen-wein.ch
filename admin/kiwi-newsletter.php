...
require_once 'include/kiwi_newsletter_form.class.php';
...
$html_header->addJS(array(
	'./js/utils.js',
	'./js/jquery-1.8.0.min.js',
	'./js/jquery-ui-1.8.23.custom.min.js',
	'./js/jquery.ui.datepicker-de.js',
	'./js/jquery-ui-timepicker-addon.js',
	'./js/jquery-ui-timepicker-de.js',
	'./js/kiwi_newsletter_form.js',
));

$html_header->addCSS(array(
	'./styles/style.css',
	'./styles/ui-lightness/jquery-ui-1.8.23.custom.css'
));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('Newsletters', $rights);
$page_items[] = $kiwi_newsletter_form = new Kiwi_Newsletter_Form($rights);
