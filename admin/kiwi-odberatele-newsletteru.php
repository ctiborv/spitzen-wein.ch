...
require_once 'include/kiwi_subscribers_form.class.php';
...
$html_header->addJS(array('./js/utils.js', './js/kiwi_subscribers_form.js'));

// Jednotlivé bloky webové stránky
$page_items = array();
$page_items[] = $kiwi_menubar = new Kiwi_MenuBar('Newsletters', $rights);
$page_items[] = $kiwi_subscribers_form = new Kiwi_Subscribers_Form();
