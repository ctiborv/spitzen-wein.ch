<?php
class HTML_DL extends HTML_Entity_Group implements HTML_Block
{
	...
	{
		if (!$content_check || $element instanceof HTML_DL_Content)
			parent::add($element, $content_check);
		else
			throw new HTML_Content_Exception('Class ' . get_class($element) . ' doesn\'t implement the HTML_DL_Content interface.');
	}
